window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "features": ["survey.type_button", "feedback.embeddable_widget", "survey.image_question", "feedback.widgetV2", "client_script.compression.pc", "settings.billing_v2", "ask.use_insights_internal_api", "feedback.widget_telemetry", "heatmap.continuous.manual_retaker", "survey.embeddable_widget", "ask.separate_service", "error_reporting"],
...
!function(e) {
    ...
    227: function(e, t, r) {
        ...
        var l, f = function() {
            ...
            return "lab" === t && (r = d.browser.inLab),
            ...
            var t = !1
              ...
              , i = JSON.stringify(e);
            if ("sendBeacon"in navigator && !d.browser.inLab)
                try {
            ...
            start: function() {
                try {
                    ...
                    h.isFieldMedtricsEnabled = h.isMetricsEnabled && Math.random() <= c.sampling,
            ...
            count: function(e, t) {
                ...
                try {
                    ...
                    if (r)
                        f = (s && s[o] || 0) + (r.value || 1),
                        h.loggedMetrics[e] = u(u({}, s), {}, c({}, o, (null == r ? void 0 : r.flush) ? 0 : f));
                    else
                        f = 1;
                    if (m(r, a)) {
                        var d = {
            ...
            timeEnd: function(e, t) {
                ...
                try {
                    ...
                    if (!o)
                        return;
                    var s, u = v(e, r), c = u.start, f = u.tagName, d = u.total;
                    if (n) {
        ...
        window.hjBootstrap = window.hjBootstrap || function(e, t, r) {
            var n, i = new RegExp("bot|google|headless|baidu|bing|msn|duckduckbot|teoma|slurp|yandex|phantomjs|pingdom|ahrefsbot","i"), a = (null === (n = window.navigator) || void 0 === n ? void 0 : n.userAgent) || "unknown";
            if (i.test(a))
        ...
        ,
        window.hjBootstrap("https://script.hotjar.com/", "modules.308cbc5043a6046d8664.js", "1447533"),
        ...
        window.hjLazyModules = window.hjLazyModules || {
            ...
            BROWSER_PERF: {
                js: "browser-perf.64e895eb62d4aa3bb3ec.js"
            }
        }
    }
});
