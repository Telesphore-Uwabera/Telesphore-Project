  ...
  var data = {
      "resource": {
          ...
          "tags": [{
              ...
              "priority": 1,
              "vtp_instanceDestinationId": "UA-83724137-4",
              "tag_id": 13
          }, {
              "function": "__rep",
              "vtp_containerId": "UA-83724137-4",
              "vtp_remoteConfig": ["map"],
              "tag_id": 1
          }, {
              "function": "__zone",
              "vtp_childContainers": ["list", ["map", "publicId", "G-4BJKT1KE28"]],
...
jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
  ...
  var Ug = function() {
      ...
      var a = new ib;
      a.set("containerId", 'UA-83724137-4');
      a.set("version", '1');
  ...
  ai.fe = Number("0") || 0;
  ai.ka = "dataLayer";
  ai.Tj = "ChEI8MTspgYQ28L24J2+prveARImAPOZRfqY6gRe2VIzsAmH6fSg2/2RcJVHK7e/aE46CMxsHIaauSkaApaG";
  var di = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var Yi;
  try {
      Yi = JSON.parse(sb("eyIwIjoiUlciLCIxIjoiUlctMDEiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5ydyIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
  } catch (a) {
      N(123),
      Xi(2),
      Yi = {}
  ...
  aa.isActive = function(a, b) {
      ...
      if (!c)
          return !0;
      if (!this.isActive([c.Dh], b))
          return !1;
      for (var e = 0; e < c.Oe.length; e++)
          if (this.B[c.Oe[e]].ed(b))
              return !0;
      return !1
  }
  ;
  ...
  rv.prototype.D = function(a, b) {
      var c = this.h[this.h.length - 1];
      a <= c.eventId || c.ed !== b && this.h.push({
          eventId: a,
          ed: b
      })
  }
  ;
  rv.prototype.ed = function(a) {
  ...
  ;
  rv.prototype.C = function(a, b) {
      b = b || [];
      if (!this.B || Mu[a] || this.B[a])
          return !0;
      for (var c = 0; c < b.length; ++c)
          if (this.B[b[c]])
              return !0;
  ...
  var cC = function(a, b) {
      if (!b.isGtmEvent) {
          ...
          if (void 0 === e) {
              var f = void 0;
              $B.hasOwnProperty(c) ? f = $B[c] : aC.hasOwnProperty(c) && (f = aC[c]);
              1 === f && (f = bC(c));
              h(f) ? Xt()(function() {
    ...
    , hC = function(a, b, c) {
      if (Ej() && (!c.isGtmEvent || !eC[a])) {
          var d = !Sj(P.g.R)
            , e = function(f) {
              var g, k, m = Xt(), n = fC(b, "", c), p, q = n.createOnlyFields._useUp;
              if (c.isGtmEvent || gC(b, n.createOnlyFields)) {
                  c.isGtmEvent && (g = "gtm" + vi(),
    ...
    , rC = function(a, b, c) {
      function d() {
          var I = U(c, P.g.Kc);
          k(function() {
              if (!c.isGtmEvent && gd(I)) {
                  var O = u.fieldsToSend, R = m().getByName(n), X;
                  for (X in I)
                      if (I.hasOwnProperty(X) && /^(dimension|metric)\d+$/.test(X) && void 0 != I[X]) {
                          var ha = R.get(bC(I[X]));
                          jC(O, X, ha)
                      }
              }
      ...
      if (Da(k)) {
          ...
          var p = function(I) {
            ...
            , q = function(I) {
              var O = function(ba, ia) {
                  for (var fa = 0; ia && fa < ia.length; fa++)
                      p(ba, ia[fa])
              }
                , R = c.isGtmEvent
                , X = R ? kC(u) : lC(b, c);
              if (X) {
                  ...
                  R && X.Zg && p("set", "&cu", X.Zg);
                  var V = X.action;
                  if (R || "impressions" === V)
                      if (O("ec:addImpression", X.sj),
                      !R)
                          return;
                  if ("promo_click" === V || "promo_view" === V || R && X.Ke) {
                      ...
                      if (S && 0 < S.length && "promo_click" === V) {
                          R ? p("ec:setAction", V, X.ib) : p("ec:setAction", V);
                          return
                      }
                      if (!R)
                          return
                  }
                  "promo_view" !== V && "impressions" !== V && (O("ec:addProduct", X.xc),
                  p("ec:setAction", V, X.ib))
              }
          }
            , r = function(I) {
              if (I) {
                  ...
                  if (gd(I))
                      for (var R in mC)
                          mC.hasOwnProperty(R) && nC(mC[R], R, I[R], O);
                  iC(O, x);
                  p("require", "linkid", O)
              }
          }
          ...
          if (u.createOnlyFields[P.g.Ib] && !c.isGtmEvent) {
              var w = ji || li ? nt(u.createOnlyFields[P.g.Ib], "/analytics.js") : void 0;
              w && (g = w)
          }
          var x = c.isGtmEvent ? u.fieldsToSet[P.g.Ib] : u.createOnlyFields[P.g.Ib];
          if (x) {
              var y = c.isGtmEvent ? u.fieldsToSet[P.g.Fd] : u.createOnlyFields[P.g.Fd];
              y && !oC[n] && (oC[n] = !0,
              k(bu(n, y)))
          }
          ...
          if (b === P.g.bc)
              ...
              hC(f, n, c)) : b === P.g.Ka ? cC(n, c) : "screen_view" === b ? p("send", "screenview", u.fieldsToSend) : "timing_complete" === b ? (u.fieldsToSend.hitType = "timing",
  ...
  xC[P.g.Fa] = 1,
  xC[P.g.yb] = 1,
  xC)), zC = {}, $B = Object.freeze((zC.client_storage = "storage",
  zC.sample_rate = 1,
  ...
  zC[P.g.Jc] = 1,
  zC[P.g.sb] = 1,
  zC)), AC = {}, BC = Object.freeze((AC._cs = 1,
  AC._useUp = 1,
  AC.allowAnchor = 1,
  AC.allowLinker = 1,
  AC.alwaysSendReferrer = 1,
  AC.clientId = 1,
  AC.cookieDomain = 1,
  AC.cookieExpires = 1,
  AC.cookieFlags = 1,
  ...
  AC.cookiePath = 1,
  AC.cookieUpdate = 1,
  AC.legacyCookieDomain = 1,
  AC.legacyHistoryImport = 1,
  AC.name = 1,
  AC.sampleRate = 1,
  AC.siteSpeedSampleRate = 1,
  AC.storage = 1,
  AC.storeGac = 1,
  AC.useAmpClientId = 1,
  AC._cd2l = 1,
  AC)), CC = Object.freeze({
      anonymize_ip: 1
  }), DC = {}, aC = Object.freeze((DC.campaign = {
  ...
  DC.app_id = 1,
  DC.app_installer_id = 1,
  DC.app_name = 1,
  DC.app_version = 1,
  DC.description = "exDescription",
  DC.fatal = "exFatal",
  DC.language = 1,
  DC.page_hostname = "hostname",
  DC.transport_type = "transport",
  DC[P.g.ra] = "currencyCode",
  DC[P.g.wg] = 1,
  DC[P.g.sa] = "location",
  DC[P.g.Rc] = "page",
  DC[P.g.Fa] = "referrer",
  ...
  DC[P.g.cf] = 1,
  DC[P.g.Aa] = 1,
  DC)), EC = {}, FC = Object.freeze((EC.content_id = 1,
  EC.event_action = 1,
  EC.event_category = 1,
  EC.event_label = 1,
  EC.link_attribution = 1,
  EC.name = 1,
  EC[P.g.Ea] = 1,
  EC[P.g.vg] = 1,
  EC[P.g.Na] = 1,
  ...
  EC)), GC = Object.freeze({
      ...
      timingVar: 1,
      value: 1
  }), tC = Object.freeze(["item_category", "item_category2", "item_category3", "item_category4", "item_category5"]), HC = {}, mC = Object.freeze((HC.levels = 1,
  HC[P.g.Ia] = "duration",
  HC[P.g.hc] = 1,
  HC)), IC = {}, JC = Object.freeze((IC.anonymize_ip = 1,
  IC.fatal = 1,
  IC.send_page_view = 1,
  IC.store_gac = 1,
  IC.use_amp_client_id = 1,
  IC[P.g.Da] = 1,
  IC[P.g.wg] = 1,
  IC)), nC = function(a, b, c, d) {
      if (void 0 !== c)
          if (JC[b] && (c = Pa(c)),
  ...
  }, KC = {}, pC = Object.freeze((KC.checkout_progress = 1,
  KC.select_content = 1,
  ...
  KC[P.g.ac] = 1,
  KC[P.g.Ca] = 1,
  KC)), LC = {}, MC = Object.freeze((LC.checkout_progress = 1,
  ...
  LC[P.g.ac] = 1,
  LC[P.g.dg] = 1,
  LC)), NC = {}, OC = Object.freeze((NC.generate_lead = 1,
  NC.login = 1,
  NC.search = 1,
  NC.select_content = 1,
  NC.share = 1,
  NC.sign_up = 1,
  NC.view_search_results = 1,
  NC[P.g.Zb] = 1,
  NC[P.g.Za] = 1,
  NC[P.g.pb] = 1,
  NC[P.g.ab] = 1,
  ...
  NC)), PC = function(a) {
      ...
      return b
  }, QC = {}, RC = Object.freeze((QC.view_search_results = 1,
  QC[P.g.Za] = 1,
  QC[P.g.ab] = 1,
  QC[P.g.Ca] = 1,
  QC)), jC = function(a, b, c) {
      ...
      for (var r = !c.isGtmEvent, t = Tk(c), u = 0; u < t.length; ++u) {
          var v = t[u];
          if (c.isGtmEvent) {
              var w = d(v);
              GC.hasOwnProperty(v) ? e[v] = w : BC.hasOwnProperty(v) ? k[v] = w : g[v] = w
          } else {
              var x = void 0;
              x = v !== P.g.aa ? d(v) : Uk(c, v);
              if (FC.hasOwnProperty(v))
                  nC(FC[v], v, x, e);
              else if (CC.hasOwnProperty(v))
                  nC(CC[v], v, x, g);
              else if (aC.hasOwnProperty(v))
                  nC(aC[v], v, x, f);
              else if ($B.hasOwnProperty(v))
                  nC($B[v], v, x, k);
                  ...
                  var A = void 0
                    , B = void 0;
                  b === P.g.oa ? A = cb(Uk(c, v), ".") : (A = cb(Uk(c, v, 1), "."),
                  B = cb(Uk(c, v, 2), "."));
                  A && (f["&gdid"] = A);
                  B && (f["&edid"] = B)
              } else
                  v === P.g.Ma && 0 > t.indexOf(P.g.hc) && (k.cookieName = x + "_ga");
              T(44) && yC[v] && (c.C.hasOwnProperty(v) || b === P.g.oa && c.h.hasOwnProperty(v)) && (r = !1)
          }
      }
      T(44) && r && (f["&jsscut"] = "1");
      !1 !== d(P.g.Re) && !1 !== d(P.g.rb) && YB() || (g.allowAdFeatures = !1);
      ml(c) && ZB() ? T(54) && (g.allowAdPersonalizationSignals = !0) : g.allowAdPersonalizationSignals = !1;
      ...
      if (c.isGtmEvent) {
          ...
          jC(g, "forceSSL", !0);
          jC(e, "eventCategory", PC(b));
          RC[b] && jC(f, "nonInteraction", !0);
          "login" === b || "sign_up" === b || "share" === b ? jC(e, "eventLabel", d(P.g.vg)) : "search" === b || "view_search_results" === b ? jC(e, "eventLabel", d(P.g.Hi)) : "select_content" === b && jC(e, "eventLabel", d(P.g.ji));
          var G = e[P.g.Ea] || {}
            , F = G[P.g.kc];
          F || 0 != F && G[P.g.U] ? k.allowLinker = !0 : !1 === F && jC(k, "useAmpClientId", !1);
          f.hitCallback = c.onSuccess;
          k.name = a
      }
      Ej() && (g["&gcs"] = nl(),
      T(50) && (g["&gcd"] = rl(c)),
      Sj(P.g.R) || (k.storage = "none"),
      Sj(P.g.I) || (g.allowAdFeatures = !1,
      k.storeGac = !1));
      T(52) && (Tj() && (g["&dma_cps"] = sl()),
      g["&dma"] = Yi["6"] ? "1" : "0");
      var I = pt(c) || d(P.g.Ib)
        , O = d(P.g.Fd);
      I && (c.isGtmEvent || (k[P.g.Ib] = I),
      k._cd2l = !0);
      O && !c.isGtmEvent && (k[P.g.Fd] = O);
      e.fieldsToSend = f;
      e.fieldsToSet = g;
      ...
      if (b.promoView) {
          ...
          c.Ke = "promoView" === b.translateIfKeyEquals ? uC(e) : e
      }
      if (b.promoClick) {
          c.action = "promo_click";
          var f = b.promoClick.promotions;
          c.Ke = "promoClick" === b.translateIfKeyEquals ? uC(f) : f;
      ...
      for (var g in b)
          if (b.hasOwnProperty(g) && "translateIfKeyEquals" !== g && "impressions" !== g && "promoView" !== g && "promoClick" !== g && "currencyCode" !== g) {
              c.action = g;
              var k = b[g].products;
              c.xc = "products" === b.translateIfKeyEquals ? uC(k) : k;
      ...
      function c(u) {
          return {
              id: d(P.g.wa),
              affiliation: d(P.g.gg),
              revenue: d(P.g.ia),
              tax: d(P.g.Ve),
              shipping: d(P.g.Nc),
              coupon: d(P.g.hg),
              list: d(P.g.Ue) || d(P.g.Mc) || u
          }
      }
      for (var d = function(u) {
          return U(b, u)
      }, e = d(P.g.Z), f, g = 0; e && g < e.length && !(f = e[g][P.g.Ue] || e[g][P.g.Mc]); g++)
          ;
      var k = d(P.g.Kc);
      if (gd(k))
      ...
      else if ("select_content" === a || a === P.g.Zb)
          q = {
              action: "click",
              ib: {
                  list: d(P.g.Ue) || d(P.g.Mc) || f
              },
              xc: uC(e)
          };
      else if (a === P.g.Fb || "checkout_progress" === a) {
          var t = {
              step: a === P.g.Fb ? 1 : d(P.g.Te),
              option: d(P.g.yd)
          };
          q = {
              action: "checkout",
  ...
  function() {
      (function(a) {
          ...
          var b = mk(a.vtp_containerId), c = So(b, !0), d;
          switch (c.prefix) {
          case "AW":
              d = xB;
              break;
          ...
          case "UA":
              ...
              break;
          case "MC":
              d = UE(c, a.vtp_gtmEventId);
              break;
          default:
              J(a.vtp_gtmOnFailure);
              return
          }
          d ? (J(a.vtp_gtmOnSuccess),
          Mv(b, d),
          a.vtp_remoteConfig && Rv(b, a.vtp_remoteConfig || {})) : J(a.vtp_gtmOnFailure)
      })
  }();
  ...
  function() {
      ...
      (function(c) {
          ...
          if (c.vtp_gtmTagId in a)
              tv(a[c.vtp_gtmTagId], c.vtp_gtmEventId, d);
          else if (d) {
              var e = c.vtp_childContainers.map(function(m) {
                ...
                , g = {};
              var k = sv(c.vtp_gtmEventId, e, f, g, Nt(1, c.vtp_gtmEntityIndex, c.vtp_gtmEntityName), !!c.vtp_inheritParentConfig);
              a[c.vtp_gtmTagId] = k
          }
