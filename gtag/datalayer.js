  ...
  var data = {
      "resource": {
          ...
          "tags": [{
              ...
              "priority": 6,
              "vtp_includeConditions": ["list", "jbkaloya\\.com"],
              "tag_id": 18
          }, {
              ...
              "priority": 5,
              "vtp_instanceDestinationId": "G-4BJKT1KE28",
              "tag_id": 26
          }, {
...
jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
  ...
  var Ug = function() {
      ...
      var a = new ib;
      a.set("containerId", 'G-4BJKT1KE28');
      a.set("version", '2');
  ...
  ai.fe = Number("0") || 0;
  ai.ka = "dataLayer";
  ai.Tj = "ChEI8MTspgYQ28L24J2+prveARIlAPOZRfqPaLCX9091LLxf75hSFFqvI+sZMDyyHFz/5RdS0mn4SBoCcTg\x3d";
  var di = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  ;function Oy() {
      var a = ["&cv=2", "&rv=" + ai.Rg, "&tc=" + df.filter(function(b) {
          return b
      }).length];
  ...
  var zz = function(a) {
      return null != a && void 0 !== a.length && Da(a.push)
  }
    , Cz = function(a) {
      var b = Az.exec(a[0]);
      if (!b)
      ...
      var g = Bz[d]
        , k = e;
      if (1 == k.length && null != k[0] && "object" === typeof k[0])
          f = k[0];
      else {
